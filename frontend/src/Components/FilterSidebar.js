...
function FilterSidebar({ filters, setFilters }) {
  ...
  // Update `renderThumb` to handle `key` properly
  const renderThumb = (props) => {
    const { key, ...restProps } = props; // Destructure `key` from props
    return <div key={key} {...restProps} />; // Apply `key` directly and spread the rest
  };
    ...
    <div className="filter-sidebar">
      ...
      <div className="filter-price">
        ...
        <ReactSlider
          ...
          renderThumb={renderThumb} // Use updated `renderThumb` function
        />
