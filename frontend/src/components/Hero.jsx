...
const Hero = () => {
  return (<>
    ...
    <div className='flex flex-col sm:flex-row border border-gray-100 bg-[#ebedf7] mt-8'>
      {/* Hero Left Side */}
      <div className='w-full sm:w-1/2 flex flex-col items-center justify-center py-4 sm:py-0 px-4'>
        ...
        <div className='bg-[#5a2b8b] text-white p-2 rounded mt-4 flex items-center'>
      ...
      <img className='w-full sm:w-1/2 object-cover' src={banner} alt="Banner" />
    </div>
  </>
  );
};
